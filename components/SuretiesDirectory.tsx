        ...
        <div className="space-y-10 animate-in fade-in duration-500 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {filteredSureties.map(surety => {
                    ...
                    return (
                        <div key={surety.id} className={`bg-white rounded-[2.5rem] border transition-all flex flex-col group relative overflow-hidden ${isEditing ? 'ring-4 ring-gold/30 shadow-2xl z-10' : 'border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-1'}`}>
                                ...
                                <div className="flex items-center gap-2 ml-4">
                                    {isEditing ? (
                                        ...
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button onClick={() => handleDelete(surety.id)} className="text-slate-300 hover:text-rose-500 transition-colors p-3 hover:bg-rose-50 rounded-2xl"><X size={20} /></button>
                                        </div>
                                    )}
                                </div>
                            </div>
