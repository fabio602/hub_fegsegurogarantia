        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-10 shadow-2xl">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-slate-600 outline-none focus:ring-2 focus:ring-gold/50 transition-all font-medium"
          ...
          <div className="mt-6 text-center">
            <a
              ...
              className="inline-flex items-center gap-2 text-gold text-xs font-bold hover:underline"
            >
