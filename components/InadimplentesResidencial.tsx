...
export default function InadimplentesResidencial() {
  ...
  const sendWhatsApp = async (item: Inadimplente, tipo: 'cobranca' | 'boleto') => {
    ...
    if (tipo === 'cobranca') {
      message = `Olá ${nome}! Tudo bem? 😊\n\nAqui é a F&G Seguro Garantia.\n\nSou o corretor responsável em cuidar do seu seguro residencial e notei uma pendência (apólice ${item.apolice || '—'}, parcela ${item.parcela || '—'} de ${valor} com vencimento em ${venc}).\n\nPodemos ajudar a resolver? É só me avisar como prefere regularizar 🙏`;
    } else {
