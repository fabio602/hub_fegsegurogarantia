...
export const MODULOS: Modulo[] = [
  { key: 'garantia', label: 'Seguro Garantia', views: ['goals', 'directory', 'banks', 'letter', 'calculator', 'endosso-allseg', 'formularios', 'carteira', 'posvenda', 'prospeccao', 'radar', 'radar-advogados', 'prospeccao-email', 'email-trilhas', 'pncp-prospeccao', 'pncp-auto', 'garimpo', 'pnpc', 'seg-licitante', 'seg-contrato'] },
  ...
  { key: 'saude', label: 'Plano de Saúde', views: ['saude-funil', 'saude-simulador', 'saude-prospeccao', 'saude-materiais', 'saude-nomeacao'] },
