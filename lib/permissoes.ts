...
export const MODULOS: Modulo[] = [
  { key: 'garantia', label: 'Seguro Garantia', views: ['goals', 'directory', 'banks', 'letter', 'calculator', 'endosso-allseg', 'carteira', 'posvenda', 'prospeccao', 'prospeccao-email', 'email-trilhas', 'pncp-prospeccao', 'pncp-auto', 'garimpo', 'pnpc', 'seg-licitante', 'seg-contrato'] },
  ...
  { key: 'financeiro', label: 'Gestão Financeira', views: ['metas-mensais', 'metas-anuais'] },
