        ...
        messages: [
          {
            ...
            content: [
              ...
              { type: 'text', text: pdfs.length > 1
                ? `Analise os ${pdfs.length} documentos acima em conjunto (contrato, termo de referência e/ou adendos) e extraia as informações solicitadas considerando todos eles.\n\n${prompt}`
                : prompt },
            ],
          },
        ],
